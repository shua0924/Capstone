...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="container mx-auto p-6 flex-1">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-2xl font-semibold text-black">Analytics</h1>
                <div class="flex items-center space-x-2">
                    <svg width="40" height="40" viewBox="0 0 67 58" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <ellipse cx="33.5" cy="29" rx="33.5" ry="29" fill="#D4E3F6" />
                        <path
                            d="M33.5 27.6667C27.9219 27.6667 23.4038 23.9375 23.4038 19.3333C23.4038 14.7292 27.9219 11 33.5 11C39.0781 11 43.5962 14.7292 43.5962 19.3333C43.5962 23.9375 39.0781 27.6667 33.5 27.6667ZM30.9339 31.5556H36.0661C36.8822 31.5556 37.5385 32.0972 37.5385 32.7708C37.5385 33.0625 37.4123 33.3403 37.1851 33.5625L34.8798 35.7847L37.488 43.7778H37.5385L40.4495 34.1597C40.6346 33.5556 41.3834 33.1875 42.0901 33.4097C47.2981 35.0486 51 39.2153 51 44.0903C51 45.1389 49.9651 45.9931 48.6947 45.9931L18.3053 46C17.0349 46 16 45.1458 16 44.0972C16 39.2222 19.7019 35.0556 24.9099 33.4167C25.6166 33.1944 26.3654 33.5625 26.5505 34.1667L29.4615 43.7847H29.512L32.1202 35.7917L29.8149 33.5694C29.5877 33.3472 29.4615 33.0694 29.4615 32.7778C29.4615 32.1042 30.1178 31.5625 30.9339 31.5625V31.5556Z"
                            fill="#0E1C79" />
                    </svg>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 py-4">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Total Students Registerd</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-4 rounded-lg shadow border h-[350px] flex flex-col justify-center items-center">
                    ...
                    <canvas id="courseChart" class="!w-[450px] !h-[250px]"></canvas>
                </div>
                ...
                <div
                    ...
                    <canvas id="trafficChart" class="!w-full !h-[250px]"></canvas>
                </div>
            </div>
    ...
    <script>
        ...
        new Chart(courseCtx, {
            type: 'doughnut',
            data: {
                labels: ['BSIT', 'BSED', 'BEED', 'BSHM', 'BSTM', 'BSCRIM'],
                datasets: [{
        ...
        // Daily Wi-Fi Connections Bar Chart

...
<body class="bg-gray-100">
  <div class="flex">
    ...
    <div class="w-64 bg-white-200 h-screen p-8 text-white shadow-lg overflow-y-auto">
      ...
      <!-- ...sidebar links... -->
      <ul class="space-y-5">
        <li><a href="admindashboard.php" class="flex items-center space-x-3 hover:bg-gray-300 p-2 rounded"><svg width="25" height="25" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li><a href="User.php" class="flex items-center space-x-3 hover:bg-gray-300 p-2 rounded"> <svg width="25" height="25" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li><a href="../php/Voucher.php" class="flex items-center space-x-3 hover:bg-gray-300 p-2 rounded"><svg width="25" height="25" viewBox="0 0 27 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
        ...
        <li><a href="../php/Analytics.php" class="flex items-center space-x-3 hover:bg-gray-300 p-2 rounded"><svg width="25" height="25" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="container mx-auto p-6 flex-1">
      ...
      <div class="flex justify-between mb-4">
        <div>
          <button id="openModalBtn" class="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
        ...
        <form method="get" id="filterForm" class="flex gap-4 items-center">
          ...
          <input type="text" name="q" id="search_user" value="<?= htmlentities($q) ?>" placeholder="Search user..." class="bg-white border border-gray-300 rounded-md px-3 py-2 text-sm w-56">
          ...
          <form id="createUserForm" method="post" action="create_user.php">
            <div class="grid grid-cols-3 gap-2 mb-2">
              <div>
                ...
                <input id="first_name" name="first_name" required type="text" placeholder="First" class="w-full mt-1 border rounded px-3 py-2 text-sm">
              </div>
              <div>
              ...
              <div>
                ...
                <input id="last_name" name="last_name" required type="text" placeholder="Last" class="w-full mt-1 border rounded px-3 py-2 text-sm">
              </div>
            </div>
            ...
            <div class="mb-2">
              ...
              <input id="gmail" name="gmail" required type="email" placeholder="Enter Gmail" class="w-full mt-1 border rounded px-3 py-2 text-sm">
            </div>
            ...
            <div id="successMsg" class="hidden mt-3 text-green-800 bg-green-100 border border-green-300 rounded-md px-3 py-2 text-sm text-center">
            ...
            <div class="flex justify-end pt-3">
              <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-md font-medium">Save User</button>
            </div>
          </form>
        </div>
      </div>

    ...
    <div class="flex ">
        ...
        <div class="container mx-auto p-6 flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <!-- Recent Activity -->
                <div class="bg-white p-6 rounded-lg shadow-lg h-[350px] border-blue-200 flex flex-col">
    <h6 class="text-lg font-semibold mb-3 text-gray-700">Recent Activities</h6>

    <div class="overflow-y-auto">
        <table class="min-w-full text-sm border-collapse">
            <thead class="bg-[#4B6BFB] text-white w-full">
                <tr>
